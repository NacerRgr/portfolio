  ...
  return (
    <section id="education" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-inter font-bold">Education</h2>
          <div className="w-20 h-1 bg-primary mx-auto mt-2 mb-6"></div>
          <p className="max-w-2xl mx-auto text-gray-600">My academic background and qualifications</p>
        </motion.div>
        ...
        >
          <h3 className="text-xl font-semibold mb-4 font-inter">Certifications & Languages</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-lg font-medium mb-3 font-inter">Languages</h4>
            ...
            <div>
              <h4 className="text-lg font-medium mb-3 font-inter">Soft Skills</h4>
