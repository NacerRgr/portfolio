    ...
    <section id="about" className="py-16 md:py-24 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <div className="rounded-lg overflow-hidden shadow-lg dark:shadow-gray-800">
              <svg
                width="100%"
                height="300"
                viewBox="0 0 800 600"
              ...
              >
                ...
                <path
                  ...
                  fill="#2563eb33"
                  className="dark:fill-blue-800/30"
                />
                <path
                  d="M-100,300 C100,400 300,150 500,300 S700,400 900,300 V600 H-100 Z"
                  fill="#2563eb44"
                  className="dark:fill-blue-700/40"
                />
                <g transform="translate(400, 250)">
                  <rect x="-150" y="-10" width="300" height="200" rx="10" fill="#fff" stroke="#e2e8f0" strokeWidth="2" className="dark:fill-gray-700 dark:stroke-gray-600" />
                  <rect x="-130" y="20" width="260" height="120" rx="5" fill="#f1f5f9" className="dark:fill-gray-600" />
                  <rect x="-110" y="160" width="220" height="15" rx="3" fill="#e2e8f0" className="dark:fill-gray-500" />
                  <circle cx="-160" cy="-25" r="7" fill="#2563eb" className="dark:fill-blue-500" />
                  <circle cx="-140" cy="-25" r="7" fill="#f59e0b" className="dark:fill-amber-500" />
                  <circle cx="-120" cy="-25" r="7" fill="#10b981" className="dark:fill-emerald-500" />
                  <rect x="-110" y="40" width="80" height="10" rx="2" fill="#2563eb55" className="dark:fill-blue-500/50" />
                  <rect x="-110" y="60" width="120" height="10" rx="2" fill="#2563eb44" className="dark:fill-blue-500/40" />
                  <rect x="-110" y="80" width="100" height="10" rx="2" fill="#2563eb33" className="dark:fill-blue-500/30" />
                  <rect x="-110" y="100" width="90" height="10" rx="2" fill="#2563eb22" className="dark:fill-blue-500/20" />
                  <rect x="-110" y="120" width="130" height="10" rx="2" fill="#2563eb11" className="dark:fill-blue-500/10" />
                </g>
              </svg>
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-2xl font-semibold mb-4 font-inter dark:text-white">Who am I?</h3>
