    ...
    <section id="contact" className="py-16 md:py-24 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className={`focus-visible:ring-primary dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 ${errors.name ? 'border-red-500' : ''}`}
                      required
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={handleChange}
                      className={`focus-visible:ring-primary dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 ${errors.email ? 'border-red-500' : ''}`}
                      required
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={handleChange}
                      className={`focus-visible:ring-primary dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 ${errors.subject ? 'border-red-500' : ''}`}
                      required
                    />
                    {errors.subject && <p className="text-sm text-red-500 dark:text-red-400">{errors.subject}</p>}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      onChange={handleChange}
                      className={`focus-visible:ring-primary dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 ${errors.message ? 'border-red-500' : ''}`}
                      required
                    />
          ...
          >
            <Card className="h-full dark:bg-gray-700 dark:border-gray-600">
              <CardContent className="p-8 h-full flex flex-col">
                <h3 className="text-2xl font-semibold mb-6 font-inter dark:text-white">Contact Information</h3>
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="flex items-start">
                    <div className="bg-primary/10 dark:bg-primary/20 rounded-full p-3 mr-4">
                      <i className="fas fa-globe text-primary dark:text-blue-400"></i>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-1">Social</h4>
                ...
                <div className="mt-auto rounded-lg overflow-hidden">
                  ...
                  >
                    <rect width="800" height="400" fill="#f1f5f9" className="dark:fill-gray-800" />
                    <circle cx="400" cy="200" r="150" fill="#e2e8f0" className="dark:fill-gray-700" />
                    <path
                      d="M300,150 Q400,50 500,150 T700,150 Q650,250 700,350 Q550,375 400,350 Q250,375 100,350 Q150,250 100,150 Q200,50 300,150"
                      fill="#2563eb11"
                      stroke="#2563eb22"
                      strokeWidth="2"
                      className="dark:fill-blue-900/20 dark:stroke-blue-900/30"
                    />
                    <path
                      ...
                      stroke="#2563eb33"
                      strokeWidth="2"
                      className="dark:fill-blue-900/30 dark:stroke-blue-900/40"
                    />
                    <g transform="translate(400, 200)">
                      <rect x="-40" y="-50" width="80" height="100" rx="5" fill="white" stroke="#e2e8f0" strokeWidth="2" className="dark:fill-gray-600 dark:stroke-gray-500" />
                      <rect x="-30" y="-40" width="60" height="10" rx="2" fill="#2563eb33" className="dark:fill-blue-500/30" />
                      <rect x="-30" y="-25" width="60" height="10" rx="2" fill="#2563eb22" className="dark:fill-blue-500/20" />
                      <rect x="-30" y="-10" width="40" height="10" rx="2" fill="#2563eb11" className="dark:fill-blue-500/10" />
                      <circle cx="-20" cy="25" r="10" fill="#2563eb44" className="dark:fill-blue-500/40" />
                      <circle cx="0" cy="25" r="10" fill="#2563eb33" className="dark:fill-blue-500/30" />
                      <circle cx="20" cy="25" r="10" fill="#2563eb22" className="dark:fill-blue-500/20" />
                    </g>
                  </svg>
                </div>
              </CardContent>
