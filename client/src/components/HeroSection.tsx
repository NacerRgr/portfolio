    ...
    <section id="home" className="pt-24 md:pt-32 pb-16 md:pb-24">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-inter font-bold leading-tight mb-4">
              Hi, I'm <span className="text-primary">Mohamed Nacer</span>
            </h1>
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden bg-primary/10 border-8 border-white shadow-xl">
              <svg 
                viewBox="0 0 200 200"
